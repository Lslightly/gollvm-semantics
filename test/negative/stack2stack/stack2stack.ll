...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum BD955B5AA340C804A325B6DB473D27AB0714FD98\\n\22"
module asm "\09.text"
...
then.8:                                           ; preds = %else.7
  ...
  %tmpv.12.sroa.0.0.cast.19.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.12.sroa.0.0.copyload = load i64, i64* %tmpv.12.sroa.0.0.cast.19.sroa_idx, align 8
  %tmpv.13.sroa.0.0.cast.24.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.13.sroa.0.0.copyload = load i64, i64* %tmpv.13.sroa.0.0.cast.24.sroa_idx, align 8
...
entry:
  %cast.29 = bitcast i8* %key1 to [61 x { i32, i64, i64 }]*
  %cast.30 = bitcast i8* %key2 to [61 x { i32, i64, i64 }]*
...
then.21:                                          ; preds = %label.0, %entry.split
  ...
  %tmpv.28.sroa.4.0.cast.33.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.29, i64 0, i64 %tmpv.26.018, i32 2
  %tmpv.28.sroa.4.0.copyload = load i64, i64* %tmpv.28.sroa.4.0.cast.33.sroa_idx7, align 8
  %tmpv.28.sroa.3.0.cast.33.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.29, i64 0, i64 %tmpv.26.018, i32 1
  %tmpv.28.sroa.3.0.copyload = load i64, i64* %tmpv.28.sroa.3.0.cast.33.sroa_idx6, align 8
  %tmpv.28.sroa.0.0.cast.33.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.29, i64 0, i64 %tmpv.26.018, i32 0
  %tmpv.28.sroa.0.0.copyload = load i32, i32* %tmpv.28.sroa.0.0.cast.33.sroa_idx, align 8
  %tmpv.29.sroa.0.0.cast.38.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.30, i64 0, i64 %tmpv.26.018, i32 0
  %tmpv.29.sroa.0.0.copyload = load i32, i32* %tmpv.29.sroa.0.0.cast.38.sroa_idx, align 8
  %tmpv.29.sroa.3.0.cast.38.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.30, i64 0, i64 %tmpv.26.018, i32 1
  %tmpv.29.sroa.3.0.copyload = load i64, i64* %tmpv.29.sroa.3.0.cast.38.sroa_idx4, align 8
  %tmpv.29.sroa.4.0.cast.38.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.30, i64 0, i64 %tmpv.26.018, i32 2
  %tmpv.29.sroa.4.0.copyload = load i64, i64* %tmpv.29.sroa.4.0.cast.38.sroa_idx5, align 8
...
entry:
  %cast.49 = bitcast i8* %key1 to [33 x double]*
  %cast.50 = bitcast i8* %key2 to [33 x double]*
...
label.0:                                          ; preds = %then.36
  ...
  %index.2.1 = getelementptr [33 x double], [33 x double]* %cast.49, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, double* %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], [33 x double]* %cast.50, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  ...
  %index.2.2 = getelementptr [33 x double], [33 x double]* %cast.49, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, double* %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], [33 x double]* %cast.50, i64 0, i64 %add.1.1
...
then.36:                                          ; preds = %label.0.2, %entry.split
  ...
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.49, i64 0, i64 %tmpv.53.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.50, i64 0, i64 %tmpv.53.011
...
entry:
  %cast.53 = bitcast i8* %key1 to [27 x { i8*, i64 }]*
  %cast.54 = bitcast i8* %key2 to [27 x { i8*, i64 }]*
...
then.41:                                          ; preds = %then.44
  %icmp.47 = icmp eq i8* %tmpv.69.sroa.0.0.copyload, %tmpv.71.sroa.0.0.copyload
...
then.44:                                          ; preds = %else.43, %entry.split
  %tmpv.67.019 = phi i64 [ %add.2, %else.43 ], [ 0, %entry.split ]
  %tmpv.69.sroa.0.0.cast.57.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.53, i64 0, i64 %tmpv.67.019, i32 0
  %tmpv.69.sroa.0.0.copyload = load i8*, i8** %tmpv.69.sroa.0.0.cast.57.sroa_idx, align 8
  %tmpv.69.sroa.3.0.cast.57.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.53, i64 0, i64 %tmpv.67.019, i32 1
  %tmpv.69.sroa.3.0.copyload = load i64, i64* %tmpv.69.sroa.3.0.cast.57.sroa_idx3, align 8
  %tmpv.71.sroa.0.0.cast.60.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.54, i64 0, i64 %tmpv.67.019, i32 0
  %tmpv.71.sroa.0.0.copyload = load i8*, i8** %tmpv.71.sroa.0.0.cast.60.sroa_idx, align 8
  %tmpv.71.sroa.3.0.cast.60.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.54, i64 0, i64 %tmpv.67.019, i32 1
  %tmpv.71.sroa.3.0.copyload = load i64, i64* %tmpv.71.sroa.3.0.cast.60.sroa_idx1, align 8
