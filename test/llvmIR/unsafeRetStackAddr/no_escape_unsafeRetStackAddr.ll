...
then.6:                                           ; preds = %else.5
  ...
  %tmpv.10.sroa.0.0.cast.16.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.10.sroa.0.0.copyload = load i64, i64* %tmpv.10.sroa.0.0.cast.16.sroa_idx, align 8
  %tmpv.11.sroa.0.0.cast.21.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.11.sroa.0.0.copyload = load i64, i64* %tmpv.11.sroa.0.0.cast.21.sroa_idx, align 8
...
entry:
  %cast.26 = bitcast i8* %key1 to [61 x { i32, i64, i64 }]*
  %cast.27 = bitcast i8* %key2 to [61 x { i32, i64, i64 }]*
...
then.19:                                          ; preds = %label.0, %entry.split
  ...
  %tmpv.26.sroa.4.0.cast.30.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.26, i64 0, i64 %tmpv.24.018, i32 2
  %tmpv.26.sroa.4.0.copyload = load i64, i64* %tmpv.26.sroa.4.0.cast.30.sroa_idx7, align 8
  %tmpv.26.sroa.3.0.cast.30.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.26, i64 0, i64 %tmpv.24.018, i32 1
  %tmpv.26.sroa.3.0.copyload = load i64, i64* %tmpv.26.sroa.3.0.cast.30.sroa_idx6, align 8
  %tmpv.26.sroa.0.0.cast.30.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.26, i64 0, i64 %tmpv.24.018, i32 0
  %tmpv.26.sroa.0.0.copyload = load i32, i32* %tmpv.26.sroa.0.0.cast.30.sroa_idx, align 8
  %tmpv.27.sroa.0.0.cast.35.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.27, i64 0, i64 %tmpv.24.018, i32 0
  %tmpv.27.sroa.0.0.copyload = load i32, i32* %tmpv.27.sroa.0.0.cast.35.sroa_idx, align 8
  %tmpv.27.sroa.3.0.cast.35.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.27, i64 0, i64 %tmpv.24.018, i32 1
  %tmpv.27.sroa.3.0.copyload = load i64, i64* %tmpv.27.sroa.3.0.cast.35.sroa_idx4, align 8
  %tmpv.27.sroa.4.0.cast.35.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.27, i64 0, i64 %tmpv.24.018, i32 2
  %tmpv.27.sroa.4.0.copyload = load i64, i64* %tmpv.27.sroa.4.0.cast.35.sroa_idx5, align 8
...
entry:
  %cast.46 = bitcast i8* %key1 to [33 x double]*
  %cast.47 = bitcast i8* %key2 to [33 x double]*
...
label.0:                                          ; preds = %then.34
  ...
  %index.2.1 = getelementptr [33 x double], [33 x double]* %cast.46, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, double* %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], [33 x double]* %cast.47, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  ...
  %index.2.2 = getelementptr [33 x double], [33 x double]* %cast.46, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, double* %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], [33 x double]* %cast.47, i64 0, i64 %add.1.1
...
then.34:                                          ; preds = %label.0.2, %entry.split
  ...
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.46, i64 0, i64 %tmpv.51.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.47, i64 0, i64 %tmpv.51.011
...
entry:
  %cast.50 = bitcast i8* %key1 to [27 x { i8*, i64 }]*
  %cast.51 = bitcast i8* %key2 to [27 x { i8*, i64 }]*
...
then.39:                                          ; preds = %then.42
  %icmp.45 = icmp eq i8* %tmpv.67.sroa.0.0.copyload, %tmpv.69.sroa.0.0.copyload
...
then.42:                                          ; preds = %else.41, %entry.split
  ...
  %tmpv.67.sroa.0.0.cast.54.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.50, i64 0, i64 %tmpv.65.019, i32 0
  %tmpv.67.sroa.0.0.copyload = load i8*, i8** %tmpv.67.sroa.0.0.cast.54.sroa_idx, align 8
  %tmpv.67.sroa.3.0.cast.54.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.50, i64 0, i64 %tmpv.65.019, i32 1
  %tmpv.67.sroa.3.0.copyload = load i64, i64* %tmpv.67.sroa.3.0.cast.54.sroa_idx3, align 8
  %tmpv.69.sroa.0.0.cast.57.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.51, i64 0, i64 %tmpv.65.019, i32 0
  %tmpv.69.sroa.0.0.copyload = load i8*, i8** %tmpv.69.sroa.0.0.cast.57.sroa_idx, align 8
  %tmpv.69.sroa.3.0.cast.57.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.51, i64 0, i64 %tmpv.65.019, i32 1
  %tmpv.69.sroa.3.0.copyload = load i64, i64* %tmpv.69.sroa.3.0.cast.57.sroa_idx1, align 8
...
entry:
  %call.0 = call i64 @main.f(i8* nest undef)
  call void @runtime.printlock(i8* nest undef)
  call void @runtime.printuint(i8* nest undef, i64 %call.0)
  call void @runtime.printnl(i8* nest undef)
  call void @runtime.printunlock(i8* nest undef)
  ret void
}

define i64 @main.f(i8* nest nocapture readnone %nest.1) local_unnamed_addr #0 {
entry:
  %call.1 = call i8* @runtime.newobject(i8* nest undef, %_type.0* nonnull @int..d)
  %cast.3 = bitcast i8* %call.1 to i64*
  store i64 1, i64* %cast.3, align 8
