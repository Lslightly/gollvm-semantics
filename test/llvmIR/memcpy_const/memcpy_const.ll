...
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22type 1 \\\22I\\\22 <type 5>\\ntype 2 \\\22S\\\22 <type 4>\\n func (s <type 2>) String () ($ret0 <type -16>) <inl:137>\\n  // /home/lqw/semantic/gollvm-semantic/test/memcpy_const.go:12\\n  { //13\\n   $ret0 = $convert(<type -16>, \\\22\\\22) //13\\n   return //13\\n  } //0\\ntype 3 (? <type -16>)\\ntype 4 struct { .main.a <type -11>; .main.b <type -11>; }\\ntype 5 interface { String () <type -16>; }\\n\22"
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 64A700295C80387ADE0039D14A1DF5D84EA104C0\\n\22"
module asm "\09.text"
...
@main.S..d = constant %StructType.0 { %_type.0 { i64 16, i64 0, i32 1464852205, i8 8, i8 8, i8 8, i8 -103, %__go_descriptor.6* bitcast (%functionDescriptor.0* @runtime.memequal128..f to %__go_descriptor.6*), i8* null, { i8*, i64 }* @go..C17, %uncommonType.0* @go..C25, %_type.0* getelementptr inbounds (%PtrType.0, %PtrType.0* @main.S..p, i32 0, i32 0) }, %IPST.11 { %structField.0* getelementptr inbounds ([2 x %structField.0], [2 x %structField.0]* @go..C43, i32 0, i32 0), i64 2, i64 2 } }
...
@const.17 = private constant [2 x i8] c"b\00", align 1
@go..C41 = internal constant { i8*, i64 } { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @const.17, i32 0, i32 0), i64 1 }
@go..C42 = internal constant { i8*, i64 } { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @const.2, i32 0, i32 0), i64 4 }
@go..C43 = internal constant [2 x %structField.0] [%structField.0 { { i8*, i64 }* @go..C34, { i8*, i64 }* @go..C35, %_type.0* @int..d, { i8*, i64 }* null, i64 0 }, %structField.0 { { i8*, i64 }* @go..C41, { i8*, i64 }* @go..C42, %_type.0* @int..d, { i8*, i64 }* null, i64 16 }]
@const.19 = private unnamed_addr constant %S.0 { i64 100, i64 20 }
@imt..interface_4String_bfunc_8_9_8string_9_5..main.S = internal constant { %_type.0*, { i8*, i64 } (i8*, %S.0*)* } { %_type.0* getelementptr inbounds (%StructType.0, %StructType.0* @main.S..d, i32 0, i32 0), { i8*, i64 } (i8*, %S.0*)* @main.S.String }
@const.21 = private constant [263 x i8] c"0w\AF\0C\92t\08\02A\E1\C1\07\E6\D6\18\E6path\09command-line-arguments\0Abuild\09-compiler=gccgo\0Abuild\09CGO_ENABLED=1\0Abuild\09CGO_CFLAGS=\0Abuild\09CGO_CPPFLAGS=\0Abuild\09CGO_CXXFLAGS=\0Abuild\09CGO_LDFLAGS=\0Abuild\09GOARCH=amd64\0Abuild\09GOEXPERIMENT=fieldtrack\0Abuild\09GOOS=linux\0Abuild\09GOAMD64=v1\0A\F92C1\86\18 r\00\82B\10A\16\D8\F2\00", align 1
...
define { i8*, i64 } @main.S.String(i8* nest nocapture readnone %nest.0, %S.0* readnone %pointer) #0 {
entry:
  %icmp.0 = icmp eq %S.0* %pointer, null
...
entry:
  call void @runtime.setmodinfo(i8* nest undef, i8* getelementptr inbounds ([263 x i8], [263 x i8]* @const.21, i64 0, i64 0), i64 262)
  ret void
}
...
entry:
  ...
  br i1 %icmp.5, label %then.8, label %else.8, !make.implicit !3
...
then.8:                                           ; preds = %entry
  ...
  br i1 %icmp.6, label %then.9, label %else.9, !make.implicit !3
...
then.9:                                           ; preds = %else.8
  ...
  %tmpv.21.sroa.0.0.cast.88.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.21.sroa.0.0.copyload = load i64, i64* %tmpv.21.sroa.0.0.cast.88.sroa_idx, align 8
  %tmpv.22.sroa.0.0.cast.93.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.22.sroa.0.0.copyload = load i64, i64* %tmpv.22.sroa.0.0.cast.93.sroa_idx, align 8
  %icmp.7.not = icmp eq i64 %tmpv.21.sroa.0.0.copyload, %tmpv.22.sroa.0.0.copyload
  br i1 %icmp.7.not, label %else.12, label %common.ret
...
entry:
  %call.6 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 256)
  ret i8 %call.6
}
...
entry:
  %call.7 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 2048)
  ret i8 %call.7
}
...
entry:
  %cast.98 = bitcast i8* %key1 to [61 x { i32, i64, i64 }]*
  %cast.99 = bitcast i8* %key2 to [61 x { i32, i64, i64 }]*
  %icmp.14 = icmp eq i8* %key1, null
  br i1 %icmp.14, label %then.16.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.17 = icmp eq i8* %key2, null
  br i1 %icmp.17, label %then.18.split, label %then.22, !make.implicit !3

label.0:                                          ; preds = %then.22
  %add.0 = add nuw nsw i64 %tmpv.35.018, 1
...
then.22:                                          ; preds = %label.0, %entry.split
  %tmpv.35.018 = phi i64 [ %add.0, %label.0 ], [ 0, %entry.split ]
  %tmpv.37.sroa.4.0.cast.102.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.98, i64 0, i64 %tmpv.35.018, i32 2
  %tmpv.37.sroa.4.0.copyload = load i64, i64* %tmpv.37.sroa.4.0.cast.102.sroa_idx7, align 8
  %tmpv.37.sroa.3.0.cast.102.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.98, i64 0, i64 %tmpv.35.018, i32 1
  %tmpv.37.sroa.3.0.copyload = load i64, i64* %tmpv.37.sroa.3.0.cast.102.sroa_idx6, align 8
  %tmpv.37.sroa.0.0.cast.102.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.98, i64 0, i64 %tmpv.35.018, i32 0
  %tmpv.37.sroa.0.0.copyload = load i32, i32* %tmpv.37.sroa.0.0.cast.102.sroa_idx, align 8
  %tmpv.38.sroa.0.0.cast.107.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.99, i64 0, i64 %tmpv.35.018, i32 0
  %tmpv.38.sroa.0.0.copyload = load i32, i32* %tmpv.38.sroa.0.0.cast.107.sroa_idx, align 8
  %tmpv.38.sroa.3.0.cast.107.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.99, i64 0, i64 %tmpv.35.018, i32 1
  %tmpv.38.sroa.3.0.copyload = load i64, i64* %tmpv.38.sroa.3.0.cast.107.sroa_idx4, align 8
  %tmpv.38.sroa.4.0.cast.107.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.99, i64 0, i64 %tmpv.35.018, i32 2
  %tmpv.38.sroa.4.0.copyload = load i64, i64* %tmpv.38.sroa.4.0.cast.107.sroa_idx5, align 8
  %icmp.18 = icmp eq i32 %tmpv.37.sroa.0.0.copyload, %tmpv.38.sroa.0.0.copyload
  %icmp.19 = icmp eq i64 %tmpv.37.sroa.3.0.copyload, %tmpv.38.sroa.3.0.copyload
  %tmpv.44.0.in = select i1 %icmp.18, i1 %icmp.19, i1 false
  %icmp.20 = icmp eq i64 %tmpv.37.sroa.4.0.copyload, %tmpv.38.sroa.4.0.copyload
  %tmpv.45.0.in = select i1 %tmpv.44.0.in, i1 %icmp.20, i1 false
  br i1 %tmpv.45.0.in, label %label.0, label %common.ret
}
...
entry:
  ...
  br i1 %icmp.23, label %then.23, label %else.23, !make.implicit !3
...
then.23:                                          ; preds = %entry
  ...
  br i1 %icmp.24, label %then.24, label %else.24, !make.implicit !3
...
then.24:                                          ; preds = %else.23
  ...
  br i1 %icmp.25.not, label %else.27, label %common.ret
...
common.ret:                                       ; preds = %else.30, %else.27, %else.24
  ...
  br i1 %icmp.28.not, label %else.30, label %common.ret
...
entry:
  %call.8 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 976)
  ret i8 %call.8
}
...
entry:
  %call.9 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 64)
  ret i8 %call.9
}
...
entry:
  %call.10 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 128)
  ret i8 %call.10
}
...
entry:
  %call.11 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 4096)
  ret i8 %call.11
}
...
entry:
  %call.12 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 136)
  ret i8 %call.12
}

define i8 @main._633_7float64..eq(i8* nest nocapture readnone %nest.17, i8* readonly %key1, i8* readonly %key2) #0 {
entry:
  %cast.118 = bitcast i8* %key1 to [33 x double]*
  %cast.119 = bitcast i8* %key2 to [33 x double]*
  %icmp.36 = icmp eq i8* %key1, null
  br i1 %icmp.36, label %then.34.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.37 = icmp eq i8* %key2, null
  br i1 %icmp.37, label %then.35.split, label %then.37, !make.implicit !3

label.0:                                          ; preds = %then.37
  %add.1 = add nuw nsw i64 %tmpv.62.011, 1
  %index.2.1 = getelementptr [33 x double], [33 x double]* %cast.118, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, double* %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], [33 x double]* %cast.119, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  %add.1.1 = add nuw nsw i64 %tmpv.62.011, 2
  %index.2.2 = getelementptr [33 x double], [33 x double]* %cast.118, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, double* %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], [33 x double]* %cast.119, i64 0, i64 %add.1.1
...
label.0.2:                                        ; preds = %label.0.1
  %add.1.2 = add nuw nsw i64 %tmpv.62.011, 3
...
then.37:                                          ; preds = %label.0.2, %entry.split
  %tmpv.62.011 = phi i64 [ %add.1.2, %label.0.2 ], [ 0, %entry.split ]
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.118, i64 0, i64 %tmpv.62.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.119, i64 0, i64 %tmpv.62.011
...
entry:
  %call.13 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 260)
  ret i8 %call.13
}
...
entry:
  %call.14 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 32)
  ret i8 %call.14
}
...
entry:
  %call.15 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 40)
  ret i8 %call.15
}
...
entry:
  %call.16 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 512)
  ret i8 %call.16
}
...
entry:
  %call.17 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 249)
  ret i8 %call.17
}
...
entry:
  %call.18 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 129)
  ret i8 %call.18
}
...
entry:
  %cast.122 = bitcast i8* %key1 to [27 x { i8*, i64 }]*
  %cast.123 = bitcast i8* %key2 to [27 x { i8*, i64 }]*
  %icmp.43 = icmp eq i8* %key1, null
  br i1 %icmp.43, label %then.40.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.44 = icmp eq i8* %key2, null
  br i1 %icmp.44, label %then.41.split, label %then.45, !make.implicit !3
...
then.42:                                          ; preds = %then.45
  %icmp.46 = icmp eq i8* %tmpv.78.sroa.0.0.copyload, %tmpv.80.sroa.0.0.copyload
  br i1 %icmp.46, label %else.44, label %fallthrough.42

fallthrough.42:                                   ; preds = %then.42
  %call.20 = call i32 @memcmp(i8* %tmpv.78.sroa.0.0.copyload, i8* %tmpv.80.sroa.0.0.copyload, i64 %tmpv.78.sroa.3.0.copyload)
  %icmp.47 = icmp eq i32 %call.20, 0
  br i1 %icmp.47, label %else.44, label %common.ret
...
common.ret:                                       ; preds = %then.45, %else.44, %fallthrough.42
  ...
  %add.2 = add nuw nsw i64 %tmpv.76.019, 1
  %exitcond.not = icmp eq i64 %add.2, 27
  br i1 %exitcond.not, label %common.ret, label %then.45

then.45:                                          ; preds = %else.44, %entry.split
  %tmpv.76.019 = phi i64 [ %add.2, %else.44 ], [ 0, %entry.split ]
  %tmpv.78.sroa.0.0.cast.126.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.122, i64 0, i64 %tmpv.76.019, i32 0
  %tmpv.78.sroa.0.0.copyload = load i8*, i8** %tmpv.78.sroa.0.0.cast.126.sroa_idx, align 8
  %tmpv.78.sroa.3.0.cast.126.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.122, i64 0, i64 %tmpv.76.019, i32 1
  %tmpv.78.sroa.3.0.copyload = load i64, i64* %tmpv.78.sroa.3.0.cast.126.sroa_idx3, align 8
  %tmpv.80.sroa.0.0.cast.129.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.123, i64 0, i64 %tmpv.76.019, i32 0
  %tmpv.80.sroa.0.0.copyload = load i8*, i8** %tmpv.80.sroa.0.0.cast.129.sroa_idx, align 8
  %tmpv.80.sroa.3.0.cast.129.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.123, i64 0, i64 %tmpv.76.019, i32 1
  %tmpv.80.sroa.3.0.copyload = load i64, i64* %tmpv.80.sroa.3.0.cast.129.sroa_idx1, align 8
  %icmp.45 = icmp eq i64 %tmpv.78.sroa.3.0.copyload, %tmpv.80.sroa.3.0.copyload
  br i1 %icmp.45, label %then.42, label %common.ret
}
...
entry:
  %call.21 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 1024)
  ret i8 %call.21
}
...
entry:
  %call.22 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 8)
  ret i8 %call.22
}
...
entry:
  %call.23 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 64)
  ret i8 %call.23
}
...
entry:
  %call.24 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 256)
  ret i8 %call.24
}
...
entry:
  %tmpv.1 = alloca %S.0, align 8, !go_addrtaken !3
  %tmpv.3 = alloca %S.0, align 8, !go_addrtaken !3
  %tmpv.7 = alloca %S.0, align 8, !go_addrtaken !3
  %tmpv.9 = alloca %S.0, align 8, !go_addrtaken !3
  %cast.45 = bitcast %S.0* %tmpv.1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %cast.45, i8* noundef nonnull align 8 dereferenceable(16) bitcast (%S.0* @const.19 to i8*), i64 16, i1 false)
  %cast.52 = bitcast %S.0* %tmpv.3 to i8*
  %call.0 = call i8 @runtime.ifaceE2T2(i8* nest undef, %_type.0* getelementptr inbounds (%StructType.0, %StructType.0* @main.S..d, i64 0, i32 0), i8* bitcast (%StructType.0* @main.S..d to i8*), i8* nonnull %cast.45, i8* nonnull %cast.52)
  %0 = and i8 %call.0, 1
...
fallthrough.1:                                    ; preds = %then.1, %entry
  %cast.61 = bitcast %S.0* %tmpv.7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %cast.61, i8* noundef nonnull align 8 dereferenceable(16) bitcast (%S.0* @const.19 to i8*), i64 16, i1 false)
  %cast.69 = bitcast %S.0* %tmpv.9 to i8*
  %call.2 = call i8 @runtime.ifaceI2T2(i8* nest undef, %_type.0* getelementptr inbounds (%StructType.0, %StructType.0* @main.S..d, i64 0, i32 0), i8* bitcast ({ %_type.0*, { i8*, i64 } (i8*, %S.0*)* }* @imt..interface_4String_bfunc_8_9_8string_9_5..main.S to i8*), i8* nonnull %cast.61, i8* nonnull %cast.69)
  %1 = and i8 %call.2, 1
