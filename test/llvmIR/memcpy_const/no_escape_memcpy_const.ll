...
entry:
  call void @runtime.setmodinfo(i8* nest undef, i8* getelementptr inbounds ([305 x i8], [305 x i8]* @const.20, i64 0, i64 0), i64 304)
  ret void
}
...
then.9:                                           ; preds = %else.8
  ...
  %tmpv.23.sroa.0.0.cast.96.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.23.sroa.0.0.copyload = load i64, i64* %tmpv.23.sroa.0.0.cast.96.sroa_idx, align 8
  %tmpv.24.sroa.0.0.cast.101.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.24.sroa.0.0.copyload = load i64, i64* %tmpv.24.sroa.0.0.cast.101.sroa_idx, align 8
  %icmp.7.not = icmp eq i64 %tmpv.23.sroa.0.0.copyload, %tmpv.24.sroa.0.0.copyload
...
entry:
  %cast.106 = bitcast i8* %key1 to [61 x { i32, i64, i64 }]*
  %cast.107 = bitcast i8* %key2 to [61 x { i32, i64, i64 }]*
...
label.0:                                          ; preds = %then.22
  %add.0 = add nuw nsw i64 %tmpv.37.018, 1
...
then.22:                                          ; preds = %label.0, %entry.split
  %tmpv.37.018 = phi i64 [ %add.0, %label.0 ], [ 0, %entry.split ]
  %tmpv.39.sroa.4.0.cast.110.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.106, i64 0, i64 %tmpv.37.018, i32 2
  %tmpv.39.sroa.4.0.copyload = load i64, i64* %tmpv.39.sroa.4.0.cast.110.sroa_idx7, align 8
  %tmpv.39.sroa.3.0.cast.110.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.106, i64 0, i64 %tmpv.37.018, i32 1
  %tmpv.39.sroa.3.0.copyload = load i64, i64* %tmpv.39.sroa.3.0.cast.110.sroa_idx6, align 8
  %tmpv.39.sroa.0.0.cast.110.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.106, i64 0, i64 %tmpv.37.018, i32 0
  %tmpv.39.sroa.0.0.copyload = load i32, i32* %tmpv.39.sroa.0.0.cast.110.sroa_idx, align 8
  %tmpv.40.sroa.0.0.cast.115.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.107, i64 0, i64 %tmpv.37.018, i32 0
  %tmpv.40.sroa.0.0.copyload = load i32, i32* %tmpv.40.sroa.0.0.cast.115.sroa_idx, align 8
  %tmpv.40.sroa.3.0.cast.115.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.107, i64 0, i64 %tmpv.37.018, i32 1
  %tmpv.40.sroa.3.0.copyload = load i64, i64* %tmpv.40.sroa.3.0.cast.115.sroa_idx4, align 8
  %tmpv.40.sroa.4.0.cast.115.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.107, i64 0, i64 %tmpv.37.018, i32 2
  %tmpv.40.sroa.4.0.copyload = load i64, i64* %tmpv.40.sroa.4.0.cast.115.sroa_idx5, align 8
  %icmp.18 = icmp eq i32 %tmpv.39.sroa.0.0.copyload, %tmpv.40.sroa.0.0.copyload
  %icmp.19 = icmp eq i64 %tmpv.39.sroa.3.0.copyload, %tmpv.40.sroa.3.0.copyload
  %tmpv.46.0.in = select i1 %icmp.18, i1 %icmp.19, i1 false
  %icmp.20 = icmp eq i64 %tmpv.39.sroa.4.0.copyload, %tmpv.40.sroa.4.0.copyload
  %tmpv.47.0.in = select i1 %tmpv.46.0.in, i1 %icmp.20, i1 false
  br i1 %tmpv.47.0.in, label %label.0, label %common.ret
}
...
entry:
  %call.12 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 976)
  ret i8 %call.12
}
...
entry:
  %cast.126 = bitcast i8* %key1 to [33 x double]*
  %cast.127 = bitcast i8* %key2 to [33 x double]*
...
label.0:                                          ; preds = %then.37
  %add.1 = add nuw nsw i64 %tmpv.64.011, 1
  %index.2.1 = getelementptr [33 x double], [33 x double]* %cast.126, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, double* %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], [33 x double]* %cast.127, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  %add.1.1 = add nuw nsw i64 %tmpv.64.011, 2
  %index.2.2 = getelementptr [33 x double], [33 x double]* %cast.126, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, double* %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], [33 x double]* %cast.127, i64 0, i64 %add.1.1
...
label.0.2:                                        ; preds = %label.0.1
  %add.1.2 = add nuw nsw i64 %tmpv.64.011, 3
...
then.37:                                          ; preds = %label.0.2, %entry.split
  %tmpv.64.011 = phi i64 [ %add.1.2, %label.0.2 ], [ 0, %entry.split ]
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.126, i64 0, i64 %tmpv.64.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.127, i64 0, i64 %tmpv.64.011
...
entry:
  %cast.130 = bitcast i8* %key1 to [27 x { i8*, i64 }]*
  %cast.131 = bitcast i8* %key2 to [27 x { i8*, i64 }]*
...
then.42:                                          ; preds = %then.45
  %icmp.46 = icmp eq i8* %tmpv.80.sroa.0.0.copyload, %tmpv.82.sroa.0.0.copyload
  br i1 %icmp.46, label %else.44, label %fallthrough.42

fallthrough.42:                                   ; preds = %then.42
  %call.24 = call i32 @memcmp(i8* %tmpv.80.sroa.0.0.copyload, i8* %tmpv.82.sroa.0.0.copyload, i64 %tmpv.80.sroa.3.0.copyload)
  %icmp.47 = icmp eq i32 %call.24, 0
...
common.ret:                                       ; preds = %then.45, %else.44, %fallthrough.42
  ...
  %add.2 = add nuw nsw i64 %tmpv.78.019, 1
  %exitcond.not = icmp eq i64 %add.2, 27
  br i1 %exitcond.not, label %common.ret, label %then.45

then.45:                                          ; preds = %else.44, %entry.split
  %tmpv.78.019 = phi i64 [ %add.2, %else.44 ], [ 0, %entry.split ]
  %tmpv.80.sroa.0.0.cast.134.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.130, i64 0, i64 %tmpv.78.019, i32 0
  %tmpv.80.sroa.0.0.copyload = load i8*, i8** %tmpv.80.sroa.0.0.cast.134.sroa_idx, align 8
  %tmpv.80.sroa.3.0.cast.134.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.130, i64 0, i64 %tmpv.78.019, i32 1
  %tmpv.80.sroa.3.0.copyload = load i64, i64* %tmpv.80.sroa.3.0.cast.134.sroa_idx3, align 8
  %tmpv.82.sroa.0.0.cast.137.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.131, i64 0, i64 %tmpv.78.019, i32 0
  %tmpv.82.sroa.0.0.copyload = load i8*, i8** %tmpv.82.sroa.0.0.cast.137.sroa_idx, align 8
  %tmpv.82.sroa.3.0.cast.137.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.131, i64 0, i64 %tmpv.78.019, i32 1
  %tmpv.82.sroa.3.0.copyload = load i64, i64* %tmpv.82.sroa.3.0.cast.137.sroa_idx1, align 8
  %icmp.45 = icmp eq i64 %tmpv.80.sroa.3.0.copyload, %tmpv.82.sroa.3.0.copyload
...
entry:
  ...
  %tmpv.10 = alloca %S.0, align 8, !go_addrtaken !3
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %call.0, i8* noundef nonnull align 8 dereferenceable(16) bitcast (%S.0* @const.19 to i8*), i64 16, i1 false)
  ...
  %cast.54 = bitcast %S.0* %tmpv.3 to i8*
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %call.1, i8* noundef nonnull align 8 dereferenceable(16) %cast.54, i64 16, i1 false)
  %0 = and i8 %call.2, 1
...
fallthrough.1:                                    ; preds = %then.1, %entry
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %call.4, i8* noundef nonnull align 8 dereferenceable(16) bitcast (%S.0* @const.19 to i8*), i64 16, i1 false)
  ...
  %cast.75 = bitcast %S.0* %tmpv.10 to i8*
  %call.6 = call i8 @runtime.ifaceI2T2(i8* nest undef, %_type.0* getelementptr inbounds (%StructType.0, %StructType.0* @main.S..d, i64 0, i32 0), i8* bitcast ({ %_type.0*, { i8*, i64 } (i8*, %S.0*)* }* @imt..interface_4String_bfunc_8_9_8string_9_5..main.S to i8*), i8* nonnull %call.4, i8* nonnull %cast.75)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %call.5, i8* noundef nonnull align 8 dereferenceable(16) %cast.75, i64 16, i1 false)
  %1 = and i8 %call.6, 1
