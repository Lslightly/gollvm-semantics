...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 90DB301D2634B4CC5C1EC9359D64A1E45ED0283A\\n\22"
module asm "\09.text"
...
entry:
  %tmpv.4 = alloca %S.0, align 1, !go_addrtaken !3
  ...
  %cast.49 = bitcast %S.0* %tmpv.4 to i8*
  %call.2 = call i8 @runtime.ifaceI2T2(i8* nest undef, %_type.0* getelementptr inbounds (%StructType.0, %StructType.0* @main.S..d, i64 0, i32 0), i8* %i.chunk0, i8* %i.chunk1, i8* nonnull %cast.49)
  %call.3 = call i8* @runtime.newobject(i8* nest undef, %_type.0* nonnull @int..d)
  %cast.51 = bitcast i8* %call.3 to i64*
  store i64 2, i64* %cast.51, align 8
  %0 = and i8 %call.2, 1
  %trunc.2.not = icmp eq i8 %0, 0
...
entry:
  call void @runtime.setmodinfo(i8* nest undef, i8* getelementptr inbounds ([305 x i8], [305 x i8]* @const.14, i64 0, i64 0), i64 304)
  ret void
}
...
then.9:                                           ; preds = %else.8
  ...
  %tmpv.18.sroa.0.0.cast.64.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.18.sroa.0.0.copyload = load i64, i64* %tmpv.18.sroa.0.0.cast.64.sroa_idx, align 8
  %tmpv.19.sroa.0.0.cast.69.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.19.sroa.0.0.copyload = load i64, i64* %tmpv.19.sroa.0.0.cast.69.sroa_idx, align 8
  %icmp.8.not = icmp eq i64 %tmpv.18.sroa.0.0.copyload, %tmpv.19.sroa.0.0.copyload
...
entry:
  %call.7 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 256)
  ret i8 %call.7
}
...
entry:
  %call.8 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 2048)
  ret i8 %call.8
}
...
entry:
  %cast.74 = bitcast i8* %key1 to [61 x { i32, i64, i64 }]*
  %cast.75 = bitcast i8* %key2 to [61 x { i32, i64, i64 }]*
...
label.0:                                          ; preds = %then.22
  %add.0 = add nuw nsw i64 %tmpv.32.018, 1
...
then.22:                                          ; preds = %label.0, %entry.split
  %tmpv.32.018 = phi i64 [ %add.0, %label.0 ], [ 0, %entry.split ]
  %tmpv.34.sroa.4.0.cast.78.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.74, i64 0, i64 %tmpv.32.018, i32 2
  %tmpv.34.sroa.4.0.copyload = load i64, i64* %tmpv.34.sroa.4.0.cast.78.sroa_idx7, align 8
  %tmpv.34.sroa.3.0.cast.78.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.74, i64 0, i64 %tmpv.32.018, i32 1
  %tmpv.34.sroa.3.0.copyload = load i64, i64* %tmpv.34.sroa.3.0.cast.78.sroa_idx6, align 8
  %tmpv.34.sroa.0.0.cast.78.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.74, i64 0, i64 %tmpv.32.018, i32 0
  %tmpv.34.sroa.0.0.copyload = load i32, i32* %tmpv.34.sroa.0.0.cast.78.sroa_idx, align 8
  %tmpv.35.sroa.0.0.cast.83.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.75, i64 0, i64 %tmpv.32.018, i32 0
  %tmpv.35.sroa.0.0.copyload = load i32, i32* %tmpv.35.sroa.0.0.cast.83.sroa_idx, align 8
  %tmpv.35.sroa.3.0.cast.83.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.75, i64 0, i64 %tmpv.32.018, i32 1
  %tmpv.35.sroa.3.0.copyload = load i64, i64* %tmpv.35.sroa.3.0.cast.83.sroa_idx4, align 8
  %tmpv.35.sroa.4.0.cast.83.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.75, i64 0, i64 %tmpv.32.018, i32 2
  %tmpv.35.sroa.4.0.copyload = load i64, i64* %tmpv.35.sroa.4.0.cast.83.sroa_idx5, align 8
  %icmp.19 = icmp eq i32 %tmpv.34.sroa.0.0.copyload, %tmpv.35.sroa.0.0.copyload
  %icmp.20 = icmp eq i64 %tmpv.34.sroa.3.0.copyload, %tmpv.35.sroa.3.0.copyload
  %tmpv.41.0.in = select i1 %icmp.19, i1 %icmp.20, i1 false
  %icmp.21 = icmp eq i64 %tmpv.34.sroa.4.0.copyload, %tmpv.35.sroa.4.0.copyload
  %tmpv.42.0.in = select i1 %tmpv.41.0.in, i1 %icmp.21, i1 false
  br i1 %tmpv.42.0.in, label %label.0, label %common.ret
}
...
entry:
  %call.9 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 976)
  ret i8 %call.9
}
...
entry:
  %call.10 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 64)
  ret i8 %call.10
}
...
entry:
  %call.11 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 128)
  ret i8 %call.11
}
...
entry:
  %call.12 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 4096)
  ret i8 %call.12
}
...
entry:
  %call.13 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 136)
  ret i8 %call.13
}

define i8 @main._633_7float64..eq(i8* nest nocapture readnone %nest.18, i8* readonly %key1, i8* readonly %key2) #0 {
entry:
  %cast.94 = bitcast i8* %key1 to [33 x double]*
  %cast.95 = bitcast i8* %key2 to [33 x double]*
...
label.0:                                          ; preds = %then.37
  %add.1 = add nuw nsw i64 %tmpv.59.011, 1
  %index.2.1 = getelementptr [33 x double], [33 x double]* %cast.94, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, double* %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], [33 x double]* %cast.95, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  %add.1.1 = add nuw nsw i64 %tmpv.59.011, 2
  %index.2.2 = getelementptr [33 x double], [33 x double]* %cast.94, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, double* %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], [33 x double]* %cast.95, i64 0, i64 %add.1.1
...
label.0.2:                                        ; preds = %label.0.1
  %add.1.2 = add nuw nsw i64 %tmpv.59.011, 3
...
then.37:                                          ; preds = %label.0.2, %entry.split
  %tmpv.59.011 = phi i64 [ %add.1.2, %label.0.2 ], [ 0, %entry.split ]
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.94, i64 0, i64 %tmpv.59.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.95, i64 0, i64 %tmpv.59.011
...
entry:
  %call.14 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 260)
  ret i8 %call.14
}
...
entry:
  %call.16 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 40)
  ret i8 %call.16
}
...
entry:
  %call.17 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 512)
  ret i8 %call.17
}
...
entry:
  %call.18 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 249)
  ret i8 %call.18
}
...
entry:
  %call.19 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 129)
  ret i8 %call.19
}
...
entry:
  %call.20 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 32)
  ret i8 %call.20
}

define i8 @main._627_7string..eq(i8* nest nocapture readnone %nest.26, i8* readonly %key1, i8* readonly %key2) #0 {
entry:
  %cast.98 = bitcast i8* %key1 to [27 x { i8*, i64 }]*
  %cast.99 = bitcast i8* %key2 to [27 x { i8*, i64 }]*
...
then.42:                                          ; preds = %then.45
  %icmp.47 = icmp eq i8* %tmpv.75.sroa.0.0.copyload, %tmpv.77.sroa.0.0.copyload
  br i1 %icmp.47, label %else.44, label %fallthrough.42

fallthrough.42:                                   ; preds = %then.42
  %call.21 = call i32 @memcmp(i8* %tmpv.75.sroa.0.0.copyload, i8* %tmpv.77.sroa.0.0.copyload, i64 %tmpv.75.sroa.3.0.copyload)
  %icmp.48 = icmp eq i32 %call.21, 0
...
common.ret:                                       ; preds = %then.45, %else.44, %fallthrough.42
  ...
  %add.2 = add nuw nsw i64 %tmpv.73.019, 1
  %exitcond.not = icmp eq i64 %add.2, 27
  br i1 %exitcond.not, label %common.ret, label %then.45

then.45:                                          ; preds = %else.44, %entry.split
  %tmpv.73.019 = phi i64 [ %add.2, %else.44 ], [ 0, %entry.split ]
  %tmpv.75.sroa.0.0.cast.102.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.98, i64 0, i64 %tmpv.73.019, i32 0
  %tmpv.75.sroa.0.0.copyload = load i8*, i8** %tmpv.75.sroa.0.0.cast.102.sroa_idx, align 8
  %tmpv.75.sroa.3.0.cast.102.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.98, i64 0, i64 %tmpv.73.019, i32 1
  %tmpv.75.sroa.3.0.copyload = load i64, i64* %tmpv.75.sroa.3.0.cast.102.sroa_idx3, align 8
  %tmpv.77.sroa.0.0.cast.105.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.99, i64 0, i64 %tmpv.73.019, i32 0
  %tmpv.77.sroa.0.0.copyload = load i8*, i8** %tmpv.77.sroa.0.0.cast.105.sroa_idx, align 8
  %tmpv.77.sroa.3.0.cast.105.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.99, i64 0, i64 %tmpv.73.019, i32 1
  %tmpv.77.sroa.3.0.copyload = load i64, i64* %tmpv.77.sroa.3.0.cast.105.sroa_idx1, align 8
  %icmp.46 = icmp eq i64 %tmpv.75.sroa.3.0.copyload, %tmpv.77.sroa.3.0.copyload
...
entry:
  %call.22 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 1024)
  ret i8 %call.22
}
...
entry:
  %call.23 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 8)
  ret i8 %call.23
}
...
entry:
  %call.24 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 64)
  ret i8 %call.24
}
...
entry:
  %call.25 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 256)
  ret i8 %call.25
}
...
entry:
  ...
  call void @main.Test(i8* nest undef, i8* bitcast ({ %_type.0*, i64 (i8*, %S.0*, i64*)* }* @imt..interface_4main_0foo_bfunc_8_2int_9_8int_9_5..main.S to i8*), i8* nonnull %call.0)
  ret void
}
