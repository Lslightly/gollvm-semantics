...
@const.3 = private constant [317 x i8] c"0w\AF\0C\92t\08\02A\E1\C1\07\E6\D6\18\E6path\09command-line-arguments\0Abuild\09-compiler=gccgo\0Abuild\09-gccgoflags=\22-mllvm \\\22--disable-go-nil-check\\\22\22\0Abuild\09CGO_ENABLED=1\0Abuild\09CGO_CFLAGS=\0Abuild\09CGO_CPPFLAGS=\0Abuild\09CGO_CXXFLAGS=\0Abuild\09CGO_LDFLAGS=\0Abuild\09GOARCH=amd64\0Abuild\09GOEXPERIMENT=fieldtrack\0Abuild\09GOOS=linux\0Abuild\09GOAMD64=v1\0A\F92C1\86\18 r\00\82B\10A\16\D8\F2\00", align 1
...
entry:
  call void @runtime.setmodinfo(i8* nest undef, i8* getelementptr inbounds ([317 x i8], [317 x i8]* @const.3, i64 0, i64 0), i64 316)
  ret void
}
...
; Function Attrs: nofree readonly
define i8 @main._6118_7uintptr..eq(i8* nest nocapture readnone %nest.12, i8* readonly %key1, i8* readonly %key2) #2 {
entry:
  %call.6 = call i8 @runtime.memequal(i8* nest undef, i8* %key1, i8* %key2, i64 944)
  ret i8 %call.6
}
...
entry:
  %tmpv.0 = alloca [20 x i64*], align 8, !go_addrtaken !3 ; slice底部的数组
  ...
  %ptroff.0 = getelementptr inbounds [20 x i64*], [20 x i64*]* %tmpv.0, i64 0, i64 10 ; &s[10]
...
fallthrough.1:                                    ; preds = %else.2, %else.1
  ...
  %.ptroff.ld.0 = load i64*, i64** %ptroff.0, align 8 ; s[10]
  ...
  %0 = bitcast i64** %ptroff.0 to i8**  ; alloc(s[10])
  store i8* %call.0, i8** %0, align 8 ; s[10] = &a
  br label %fallthrough.1
...
then.4:                                           ; preds = %fallthrough.1
  ...
  %.ld.3 = load i64, i64* %.ptroff.ld.0, align 8  ; *s[10]
  store i64 %.ld.3, i64* %cast.5, align 8 ; a = *s[10]
  ...
  %1 = getelementptr inbounds { i8**, i64, i64 }, { i8**, i64, i64 }* %sret.actual.0, i64 0, i32 1  ; &s.len
  %s.sroa.20.0.copyload = load i64, i64* %1, align 8  ; s.len
  %2 = getelementptr inbounds { i8**, i64, i64 }, { i8**, i64, i64 }* %sret.actual.0, i64 0, i32 2  ; &s.cap
  %s.sroa.35.0.copyload = load i64, i64* %2, align 8  ; s.cap
  %ptroff.3 = getelementptr i64*, i64** %s.sroa.0.0.copyload, i64 20  ; &s[20]
...
fallthrough.7:                                    ; preds = %else.8, %else.7
  %add.3 = add i64 %s.sroa.20.0.copyload, 2 ; s.len += 2
  %icmp.12 = icmp ugt i64 %add.3, %s.sroa.35.0.copyload ; s.len s.cap
...
then.8:                                           ; preds = %then.7
  ...
  %3 = bitcast i64** %ptroff.3 to i8**  ; alloc(s[20])
  store i8* %call.0, i8** %3, align 8 ; s[20] = &a
  br label %fallthrough.7
...
fallthrough.9:                                    ; preds = %then.9, %fallthrough.7
  %s.sroa.0.1 = phi i64** [ %s.sroa.0.0.copyload55, %then.9 ], [ %s.sroa.0.0.copyload, %fallthrough.7 ] ; s.array
  %s.sroa.20.1 = phi i64 [ %s.sroa.20.0.copyload60, %then.9 ], [ %add.3, %fallthrough.7 ] ; s.len
  %s.sroa.35.1 = phi i64 [ %s.sroa.35.0.copyload66, %then.9 ], [ %s.sroa.35.0.copyload, %fallthrough.7 ]  ; s.cap
...
fallthrough.13:                                   ; preds = %else.14, %else.13
  %add.6 = shl i64 %s.sroa.20.1, 1  ; s = append(s, s...) s.len *= 2
...
fallthrough.15:                                   ; preds = %then.15, %fallthrough.13
  ...
  %call.1 = call i64 @runtime.typedslicecopy(i8* nest undef, %_type.0* getelementptr inbounds (%PtrType.0, %PtrType.0* @int..p, i64 0, i32 0), i8* %cast.52, i64 %sub.10, i8* %cast.53.pre-phi, i64 %s.sroa.20.1) ; s = append(s, s...) s[13:26] = s
