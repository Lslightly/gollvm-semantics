...
then.27:                                          ; preds = %else.26
  ...
  %tmpv.55.sroa.0.0.cast.65.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.55.sroa.0.0.copyload = load i64, i64* %tmpv.55.sroa.0.0.cast.65.sroa_idx, align 8
  %tmpv.56.sroa.0.0.cast.70.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.56.sroa.0.0.copyload = load i64, i64* %tmpv.56.sroa.0.0.cast.70.sroa_idx, align 8
  %icmp.31.not = icmp eq i64 %tmpv.55.sroa.0.0.copyload, %tmpv.56.sroa.0.0.copyload
...
label.0:                                          ; preds = %then.40
  %add.7 = add nuw nsw i64 %tmpv.69.018, 1
...
then.40:                                          ; preds = %label.0, %entry.split
  %tmpv.69.018 = phi i64 [ %add.7, %label.0 ], [ 0, %entry.split ]
  %tmpv.71.sroa.4.0.cast.79.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.75, i64 0, i64 %tmpv.69.018, i32 2
  %tmpv.71.sroa.4.0.copyload = load i64, i64* %tmpv.71.sroa.4.0.cast.79.sroa_idx7, align 8
  %tmpv.71.sroa.3.0.cast.79.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.75, i64 0, i64 %tmpv.69.018, i32 1
  %tmpv.71.sroa.3.0.copyload = load i64, i64* %tmpv.71.sroa.3.0.cast.79.sroa_idx6, align 8
  %tmpv.71.sroa.0.0.cast.79.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.75, i64 0, i64 %tmpv.69.018, i32 0
  %tmpv.71.sroa.0.0.copyload = load i32, i32* %tmpv.71.sroa.0.0.cast.79.sroa_idx, align 8
  %tmpv.72.sroa.0.0.cast.84.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.76, i64 0, i64 %tmpv.69.018, i32 0
  %tmpv.72.sroa.0.0.copyload = load i32, i32* %tmpv.72.sroa.0.0.cast.84.sroa_idx, align 8
  %tmpv.72.sroa.3.0.cast.84.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.76, i64 0, i64 %tmpv.69.018, i32 1
  %tmpv.72.sroa.3.0.copyload = load i64, i64* %tmpv.72.sroa.3.0.cast.84.sroa_idx4, align 8
  %tmpv.72.sroa.4.0.cast.84.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.76, i64 0, i64 %tmpv.69.018, i32 2
  %tmpv.72.sroa.4.0.copyload = load i64, i64* %tmpv.72.sroa.4.0.cast.84.sroa_idx5, align 8
  %icmp.42 = icmp eq i32 %tmpv.71.sroa.0.0.copyload, %tmpv.72.sroa.0.0.copyload
  %icmp.43 = icmp eq i64 %tmpv.71.sroa.3.0.copyload, %tmpv.72.sroa.3.0.copyload
  %tmpv.78.0.in = select i1 %icmp.42, i1 %icmp.43, i1 false
  %icmp.44 = icmp eq i64 %tmpv.71.sroa.4.0.copyload, %tmpv.72.sroa.4.0.copyload
  %tmpv.79.0.in = select i1 %tmpv.78.0.in, i1 %icmp.44, i1 false
  br i1 %tmpv.79.0.in, label %label.0, label %common.ret
}
...
label.0:                                          ; preds = %then.55
  %add.8 = add nuw nsw i64 %tmpv.96.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.8.1 = add nuw nsw i64 %tmpv.96.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.8.2 = add nuw nsw i64 %tmpv.96.011, 3
...
then.55:                                          ; preds = %label.0.2, %entry.split
  %tmpv.96.011 = phi i64 [ %add.8.2, %label.0.2 ], [ 0, %entry.split ]
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.95, i64 0, i64 %tmpv.96.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.96, i64 0, i64 %tmpv.96.011
...
then.60:                                          ; preds = %then.63
  %icmp.70 = icmp eq i8* %tmpv.112.sroa.0.0.copyload, %tmpv.114.sroa.0.0.copyload
  br i1 %icmp.70, label %else.62, label %fallthrough.60

fallthrough.60:                                   ; preds = %then.60
  %call.19 = call i32 @memcmp(i8* %tmpv.112.sroa.0.0.copyload, i8* %tmpv.114.sroa.0.0.copyload, i64 %tmpv.112.sroa.3.0.copyload)
  %icmp.71 = icmp eq i32 %call.19, 0
...
common.ret:                                       ; preds = %then.63, %else.62, %fallthrough.60
  ...
  %add.9 = add nuw nsw i64 %tmpv.110.019, 1
  %exitcond.not = icmp eq i64 %add.9, 27
  br i1 %exitcond.not, label %common.ret, label %then.63

then.63:                                          ; preds = %else.62, %entry.split
  %tmpv.110.019 = phi i64 [ %add.9, %else.62 ], [ 0, %entry.split ]
  %tmpv.112.sroa.0.0.cast.103.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.99, i64 0, i64 %tmpv.110.019, i32 0
  %tmpv.112.sroa.0.0.copyload = load i8*, i8** %tmpv.112.sroa.0.0.cast.103.sroa_idx, align 8
  %tmpv.112.sroa.3.0.cast.103.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.99, i64 0, i64 %tmpv.110.019, i32 1
  %tmpv.112.sroa.3.0.copyload = load i64, i64* %tmpv.112.sroa.3.0.cast.103.sroa_idx3, align 8
  %tmpv.114.sroa.0.0.cast.106.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.100, i64 0, i64 %tmpv.110.019, i32 0
  %tmpv.114.sroa.0.0.copyload = load i8*, i8** %tmpv.114.sroa.0.0.cast.106.sroa_idx, align 8
  %tmpv.114.sroa.3.0.cast.106.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.100, i64 0, i64 %tmpv.110.019, i32 1
  %tmpv.114.sroa.3.0.copyload = load i64, i64* %tmpv.114.sroa.3.0.cast.106.sroa_idx1, align 8
  %icmp.69 = icmp eq i64 %tmpv.112.sroa.3.0.copyload, %tmpv.114.sroa.3.0.copyload
...
entry:
  ...
  %call.0 = call i8* @runtime.makeslice(i8* nest undef, %_type.0* getelementptr inbounds (%PtrType.0, %PtrType.0* @int..p, i64 0, i32 0), i64 20, i64 20)
  ...
  %ptroff.0 = getelementptr i8, i8* %call.0, i64 80
  %0 = bitcast i8* %ptroff.0 to i64**
...
then.1:                                           ; preds = %entry
  %icmp.2 = icmp eq i8* %ptroff.0, null
...
fallthrough.1:                                    ; preds = %else.2, %else.1
  ...
  %.ptroff.ld.0 = load i64*, i64** %0, align 8
  ...
  call void @runtime.gcWriteBarrier(i8* nest undef, i8* %ptroff.0, i64 %pticast.0)
...
then.2:                                           ; preds = %then.1
  ...
  %1 = bitcast i8* %ptroff.0 to i8**
  store i8* %call.1, i8** %1, align 8
  br label %fallthrough.1
...
then.4:                                           ; preds = %fallthrough.1
  ...
  call void @runtime.growslice({ i8**, i64, i64 }* nonnull sret({ i8**, i64, i64 }) "go_sret" %sret.actual.0, i8* nest undef, %_type.0* getelementptr inbounds (%PtrType.0, %PtrType.0* @int..p, i64 0, i32 0), i8* nonnull %call.0, i64 20, i64 20, i64 21)
  ...
  %2 = getelementptr inbounds { i8**, i64, i64 }, { i8**, i64, i64 }* %sret.actual.0, i64 0, i32 1
  %s.sroa.20.0.copyload = load i64, i64* %2, align 8
  %3 = getelementptr inbounds { i8**, i64, i64 }, { i8**, i64, i64 }* %sret.actual.0, i64 0, i32 2
  %s.sroa.35.0.copyload = load i64, i64* %3, align 8
...
fallthrough.7:                                    ; preds = %else.8, %else.7
  ...
  %pticast.1 = ptrtoint i8* %call.1 to i64
...
then.8:                                           ; preds = %then.7
  ...
  %4 = bitcast i64** %ptroff.3 to i8**
  store i8* %call.1, i8** %4, align 8
  br label %fallthrough.7
...
then.9:                                           ; preds = %fallthrough.7
  ...
  %5 = getelementptr inbounds { i8**, i64, i64 }, { i8**, i64, i64 }* %sret.actual.1, i64 0, i32 1
  %s.sroa.20.0.copyload60 = load i64, i64* %5, align 8
  %6 = getelementptr inbounds { i8**, i64, i64 }, { i8**, i64, i64 }* %sret.actual.1, i64 0, i32 2
  %s.sroa.35.0.copyload66 = load i64, i64* %6, align 8
...
fallthrough.11:                                   ; preds = %else.12, %else.11
  ...
  %pticast.2 = ptrtoint i8* %call.1 to i64
...
then.12:                                          ; preds = %then.11
  ...
  %7 = bitcast i64** %ptroff.5 to i8**
  store i8* %call.1, i8** %7, align 8
  br label %fallthrough.11
...
fallthrough.13:                                   ; preds = %else.14, %else.13
  ...
  %pticast.3 = ptrtoint i8* %call.1 to i64
...
then.14:                                          ; preds = %then.13
  ...
  %8 = bitcast i64** %ptroff.6 to i8**
  store i8* %call.1, i8** %8, align 8
  br label %fallthrough.13
...
then.15:                                          ; preds = %fallthrough.13
  ...
  %9 = getelementptr inbounds { i8**, i64, i64 }, { i8**, i64, i64 }* %sret.actual.2, i64 0, i32 1
  %s.sroa.20.0.copyload62 = load i64, i64* %9, align 8
  %10 = getelementptr inbounds { i8**, i64, i64 }, { i8**, i64, i64 }* %sret.actual.2, i64 0, i32 2
  %s.sroa.35.0.copyload68 = load i64, i64* %10, align 8
...
fallthrough.15:                                   ; preds = %then.15, %fallthrough.13
  ...
  %call.2 = call i64 @runtime.typedslicecopy(i8* nest undef, %_type.0* getelementptr inbounds (%PtrType.0, %PtrType.0* @int..p, i64 0, i32 0), i8* %cast.52, i64 %sub.10, i8* %cast.53.pre-phi, i64 %s.sroa.20.1)
