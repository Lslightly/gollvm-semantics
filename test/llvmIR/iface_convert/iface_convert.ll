...
module asm "\09.ascii \22 216\22"
module asm "\09.ascii \22 22\22"
module asm "\09.ascii \22 38\22"
module asm "\09.ascii \22 43\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22type 1 \\\22I\\\22 <type 5>\\ntype 2 \\\22S\\\22 <type 4>\\n func (s <type 2>) String () ($ret0 <type -16>) <inl:138>\\n  // /home/lqw/semantic/gollvm-semantic/test/iface_convert.go:11\\n  { //12\\n   $ret0 = $convert(<type -16>, \\\22\\\22) //12\\n   return //12\\n  } //0\\ntype 3 (? <type -16>)\\ntype 4 struct { .main.a <type -11>; }\\ntype 5 interface { String () <type -16>; }\\n\22"
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 5E478D6F5379172AD6A696BE1C9F7C25A65036D6\\n\22"
module asm "\09.text"
...
@const.20 = private constant [263 x i8] c"0w\AF\0C\92t\08\02A\E1\C1\07\E6\D6\18\E6path\09command-line-arguments\0Abuild\09-compiler=gccgo\0Abuild\09CGO_ENABLED=1\0Abuild\09CGO_CFLAGS=\0Abuild\09CGO_CPPFLAGS=\0Abuild\09CGO_CXXFLAGS=\0Abuild\09CGO_LDFLAGS=\0Abuild\09GOARCH=amd64\0Abuild\09GOEXPERIMENT=fieldtrack\0Abuild\09GOOS=linux\0Abuild\09GOAMD64=v1\0A\F92C1\86\18 r\00\82B\10A\16\D8\F2\00", align 1
...
entry:
  call void @runtime.setmodinfo(i8* nest undef, i8* getelementptr inbounds ([263 x i8], [263 x i8]* @const.20, i64 0, i64 0), i64 262)
  ret void
}
...
entry:
  ...
  %tmpv.7 = alloca %functionDescriptor.0, align 8, !go_addrtaken !3
  %tmpv.9 = alloca %functionDescriptor.0, align 8, !go_addrtaken !3
  %cast.45 = bitcast %functionDescriptor.0* %tmpv.1 to i8*
  %s.sroa.0.0.cast.46.sroa_idx = getelementptr inbounds %functionDescriptor.0, %functionDescriptor.0* %tmpv.1, i64 0, i32 0
  store i64 100, i64* %s.sroa.0.0.cast.46.sroa_idx, align 8
  %cast.52 = bitcast %functionDescriptor.0* %tmpv.3 to i8*
...
fallthrough.1:                                    ; preds = %then.1, %entry
  %cast.61 = bitcast %functionDescriptor.0* %tmpv.7 to i8*
  %s.sroa.0.0.cast.62.sroa_idx = getelementptr inbounds %functionDescriptor.0, %functionDescriptor.0* %tmpv.7, i64 0, i32 0
  store i64 100, i64* %s.sroa.0.0.cast.62.sroa_idx, align 8
  %cast.69 = bitcast %functionDescriptor.0* %tmpv.9 to i8*
  %call.2 = call i8 @runtime.ifaceI2T2(i8* nest undef, %_type.0* getelementptr inbounds (%StructType.0, %StructType.0* @main.S..d, i64 0, i32 0), i8* bitcast ({ %_type.0*, { i8*, i64 } (i8*, %functionDescriptor.0*)* }* @imt..interface_4String_bfunc_8_9_8string_9_5..main.S to i8*), i8* nonnull %cast.61, i8* nonnull %cast.69)
  %1 = and i8 %call.2, 1
