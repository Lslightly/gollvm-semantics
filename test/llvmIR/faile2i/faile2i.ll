...
then.7:                                           ; preds = %else.6
  ...
  %tmpv.13.sroa.0.0.cast.40.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.13.sroa.0.0.copyload = load i64, i64* %tmpv.13.sroa.0.0.cast.40.sroa_idx, align 8
  %tmpv.14.sroa.0.0.cast.45.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.14.sroa.0.0.copyload = load i64, i64* %tmpv.14.sroa.0.0.cast.45.sroa_idx, align 8
  %icmp.6.not = icmp eq i64 %tmpv.13.sroa.0.0.copyload, %tmpv.14.sroa.0.0.copyload
...
entry:
  %cast.50 = bitcast i8* %key1 to [61 x { i32, i64, i64 }]*
  %cast.51 = bitcast i8* %key2 to [61 x { i32, i64, i64 }]*
...
then.20:                                          ; preds = %label.0, %entry.split
  ...
  %tmpv.29.sroa.4.0.cast.54.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.50, i64 0, i64 %tmpv.27.018, i32 2
  %tmpv.29.sroa.4.0.copyload = load i64, i64* %tmpv.29.sroa.4.0.cast.54.sroa_idx7, align 8
  %tmpv.29.sroa.3.0.cast.54.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.50, i64 0, i64 %tmpv.27.018, i32 1
  %tmpv.29.sroa.3.0.copyload = load i64, i64* %tmpv.29.sroa.3.0.cast.54.sroa_idx6, align 8
  %tmpv.29.sroa.0.0.cast.54.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.50, i64 0, i64 %tmpv.27.018, i32 0
  %tmpv.29.sroa.0.0.copyload = load i32, i32* %tmpv.29.sroa.0.0.cast.54.sroa_idx, align 8
  %tmpv.30.sroa.0.0.cast.59.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.51, i64 0, i64 %tmpv.27.018, i32 0
  %tmpv.30.sroa.0.0.copyload = load i32, i32* %tmpv.30.sroa.0.0.cast.59.sroa_idx, align 8
  %tmpv.30.sroa.3.0.cast.59.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.51, i64 0, i64 %tmpv.27.018, i32 1
  %tmpv.30.sroa.3.0.copyload = load i64, i64* %tmpv.30.sroa.3.0.cast.59.sroa_idx4, align 8
  %tmpv.30.sroa.4.0.cast.59.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.51, i64 0, i64 %tmpv.27.018, i32 2
  %tmpv.30.sroa.4.0.copyload = load i64, i64* %tmpv.30.sroa.4.0.cast.59.sroa_idx5, align 8
  %icmp.17 = icmp eq i32 %tmpv.29.sroa.0.0.copyload, %tmpv.30.sroa.0.0.copyload
  %icmp.18 = icmp eq i64 %tmpv.29.sroa.3.0.copyload, %tmpv.30.sroa.3.0.copyload
  %tmpv.36.0.in = select i1 %icmp.17, i1 %icmp.18, i1 false
  %icmp.19 = icmp eq i64 %tmpv.29.sroa.4.0.copyload, %tmpv.30.sroa.4.0.copyload
  %tmpv.37.0.in = select i1 %tmpv.36.0.in, i1 %icmp.19, i1 false
...
entry:
  %cast.70 = bitcast i8* %key1 to [33 x double]*
  %cast.71 = bitcast i8* %key2 to [33 x double]*
...
label.0:                                          ; preds = %then.35
  ...
  %index.2.1 = getelementptr [33 x double], [33 x double]* %cast.70, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, double* %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], [33 x double]* %cast.71, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  ...
  %index.2.2 = getelementptr [33 x double], [33 x double]* %cast.70, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, double* %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], [33 x double]* %cast.71, i64 0, i64 %add.1.1
...
then.35:                                          ; preds = %label.0.2, %entry.split
  ...
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.70, i64 0, i64 %tmpv.54.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.71, i64 0, i64 %tmpv.54.011
...
entry:
  %cast.74 = bitcast i8* %key1 to [27 x { i8*, i64 }]*
  %cast.75 = bitcast i8* %key2 to [27 x { i8*, i64 }]*
...
then.40:                                          ; preds = %then.43
  %icmp.45 = icmp eq i8* %tmpv.70.sroa.0.0.copyload, %tmpv.72.sroa.0.0.copyload
  br i1 %icmp.45, label %else.42, label %fallthrough.40

fallthrough.40:                                   ; preds = %then.40
  %call.16 = call i32 @memcmp(i8* %tmpv.70.sroa.0.0.copyload, i8* %tmpv.72.sroa.0.0.copyload, i64 %tmpv.70.sroa.3.0.copyload)
  %icmp.46 = icmp eq i32 %call.16, 0
...
then.43:                                          ; preds = %else.42, %entry.split
  %tmpv.68.019 = phi i64 [ %add.2, %else.42 ], [ 0, %entry.split ]
  %tmpv.70.sroa.0.0.cast.78.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.74, i64 0, i64 %tmpv.68.019, i32 0
  %tmpv.70.sroa.0.0.copyload = load i8*, i8** %tmpv.70.sroa.0.0.cast.78.sroa_idx, align 8
  %tmpv.70.sroa.3.0.cast.78.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.74, i64 0, i64 %tmpv.68.019, i32 1
  %tmpv.70.sroa.3.0.copyload = load i64, i64* %tmpv.70.sroa.3.0.cast.78.sroa_idx3, align 8
  %tmpv.72.sroa.0.0.cast.81.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.75, i64 0, i64 %tmpv.68.019, i32 0
  %tmpv.72.sroa.0.0.copyload = load i8*, i8** %tmpv.72.sroa.0.0.cast.81.sroa_idx, align 8
  %tmpv.72.sroa.3.0.cast.81.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.75, i64 0, i64 %tmpv.68.019, i32 1
  %tmpv.72.sroa.3.0.copyload = load i64, i64* %tmpv.72.sroa.3.0.cast.81.sroa_idx1, align 8
  %icmp.44 = icmp eq i64 %tmpv.70.sroa.3.0.copyload, %tmpv.72.sroa.3.0.copyload
...
entry:
  %tmpv.0 = alloca %S.0, align 1, !go_addrtaken !3
  %sret.actual.0 = alloca { %.1, i8 }, align 8
  %cast.16 = bitcast %S.0* %tmpv.0 to i8*
  call void @runtime.ifaceE2I2({ %.1, i8 }* nonnull sret({ %.1, i8 }) "go_sret" %sret.actual.0, i8* nest undef, %_type.0* getelementptr inbounds (%InterfaceType.0, %InterfaceType.0* @main.I..d, i64 0, i32 0), i8* bitcast (%StructType.0* @main.S..d to i8*), i8* nonnull %cast.16)
  %tmpv.2.sroa.2.0.cast.21.sroa_idx = getelementptr inbounds { %.1, i8 }, { %.1, i8 }* %sret.actual.0, i64 0, i32 1
  %tmpv.2.sroa.2.0.copyload = load i8, i8* %tmpv.2.sroa.2.0.cast.21.sroa_idx, align 8
  %0 = and i8 %tmpv.2.sroa.2.0.copyload, 1
  %trunc.0.not = icmp eq i8 %0, 0
  br i1 %trunc.0.not, label %fallthrough.0, label %then.0

then.0:                                           ; preds = %entry
  %tmpv.2.sroa.0.sroa.2.0.tmpv.2.sroa.0.0.cast.21.sroa_cast.sroa_idx8 = getelementptr inbounds { %.1, i8 }, { %.1, i8 }* %sret.actual.0, i64 0, i32 0, i32 1
  %tmpv.2.sroa.0.sroa.2.0.copyload = load i8*, i8** %tmpv.2.sroa.0.sroa.2.0.tmpv.2.sroa.0.0.cast.21.sroa_cast.sroa_idx8, align 8
  %tmpv.2.sroa.0.sroa.0.0.tmpv.2.sroa.0.0.cast.21.sroa_cast.sroa_cast = bitcast { %.1, i8 }* %sret.actual.0 to i8**
  %tmpv.2.sroa.0.sroa.0.0.copyload = load i8*, i8** %tmpv.2.sroa.0.sroa.0.0.tmpv.2.sroa.0.0.cast.21.sroa_cast.sroa_cast, align 8
  call void @runtime.printlock(i8* nest undef)
  call void @runtime.printiface(i8* nest undef, i8* %tmpv.2.sroa.0.sroa.0.0.copyload, i8* %tmpv.2.sroa.0.sroa.2.0.copyload)
