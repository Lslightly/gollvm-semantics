...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 34CAAB1980B305E5651D0CC91147E49B46A5066E\\n\22"
module asm "\09.text"
...
then.13:                                          ; preds = %else.12
  ...
  %tmpv.35.sroa.0.0.cast.125.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.35.sroa.0.0.copyload = load i64, i64* %tmpv.35.sroa.0.0.cast.125.sroa_idx, align 8
  %tmpv.36.sroa.0.0.cast.130.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.36.sroa.0.0.copyload = load i64, i64* %tmpv.36.sroa.0.0.cast.130.sroa_idx, align 8
...
entry:
  %cast.135 = bitcast i8* %key1 to [61 x { i32, i64, i64 }]*
  %cast.136 = bitcast i8* %key2 to [61 x { i32, i64, i64 }]*
...
then.26:                                          ; preds = %label.0, %entry.split
  ...
  %tmpv.51.sroa.4.0.cast.139.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.135, i64 0, i64 %tmpv.49.018, i32 2
  %tmpv.51.sroa.4.0.copyload = load i64, i64* %tmpv.51.sroa.4.0.cast.139.sroa_idx7, align 8
  %tmpv.51.sroa.3.0.cast.139.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.135, i64 0, i64 %tmpv.49.018, i32 1
  %tmpv.51.sroa.3.0.copyload = load i64, i64* %tmpv.51.sroa.3.0.cast.139.sroa_idx6, align 8
  %tmpv.51.sroa.0.0.cast.139.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.135, i64 0, i64 %tmpv.49.018, i32 0
  %tmpv.51.sroa.0.0.copyload = load i32, i32* %tmpv.51.sroa.0.0.cast.139.sroa_idx, align 8
  %tmpv.52.sroa.0.0.cast.144.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.136, i64 0, i64 %tmpv.49.018, i32 0
  %tmpv.52.sroa.0.0.copyload = load i32, i32* %tmpv.52.sroa.0.0.cast.144.sroa_idx, align 8
  %tmpv.52.sroa.3.0.cast.144.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.136, i64 0, i64 %tmpv.49.018, i32 1
  %tmpv.52.sroa.3.0.copyload = load i64, i64* %tmpv.52.sroa.3.0.cast.144.sroa_idx4, align 8
  %tmpv.52.sroa.4.0.cast.144.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.136, i64 0, i64 %tmpv.49.018, i32 2
  %tmpv.52.sroa.4.0.copyload = load i64, i64* %tmpv.52.sroa.4.0.cast.144.sroa_idx5, align 8
...
entry:
  %cast.155 = bitcast i8* %key1 to [33 x double]*
  %cast.156 = bitcast i8* %key2 to [33 x double]*
...
label.0:                                          ; preds = %then.41
  ...
  %index.2.1 = getelementptr [33 x double], [33 x double]* %cast.155, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, double* %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], [33 x double]* %cast.156, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  ...
  %index.2.2 = getelementptr [33 x double], [33 x double]* %cast.155, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, double* %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], [33 x double]* %cast.156, i64 0, i64 %add.1.1
...
then.41:                                          ; preds = %label.0.2, %entry.split
  ...
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.155, i64 0, i64 %tmpv.76.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.156, i64 0, i64 %tmpv.76.011
...
entry:
  %cast.159 = bitcast i8* %key1 to [27 x { i8*, i64 }]*
  %cast.160 = bitcast i8* %key2 to [27 x { i8*, i64 }]*
...
then.49:                                          ; preds = %else.48, %entry.split
  ...
  %tmpv.92.sroa.0.0.cast.163.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.159, i64 0, i64 %tmpv.90.019, i32 0
  %tmpv.92.sroa.0.0.copyload = load i8*, i8** %tmpv.92.sroa.0.0.cast.163.sroa_idx, align 8
  %tmpv.92.sroa.3.0.cast.163.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.159, i64 0, i64 %tmpv.90.019, i32 1
  %tmpv.92.sroa.3.0.copyload = load i64, i64* %tmpv.92.sroa.3.0.cast.163.sroa_idx3, align 8
  %tmpv.94.sroa.0.0.cast.166.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.160, i64 0, i64 %tmpv.90.019, i32 0
  %tmpv.94.sroa.0.0.copyload = load i8*, i8** %tmpv.94.sroa.0.0.cast.166.sroa_idx, align 8
  %tmpv.94.sroa.3.0.cast.166.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.160, i64 0, i64 %tmpv.90.019, i32 1
  %tmpv.94.sroa.3.0.copyload = load i64, i64* %tmpv.94.sroa.3.0.cast.166.sroa_idx1, align 8
