...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 25E156A0BC0879F7BA823EE5425CFBA5541A0B48\\n\22"
module asm "\09.text"
...
then.13:                                          ; preds = %else.12
  ...
  %tmpv.31.sroa.0.0.cast.120.sroa_idx = bitcast i8* %key1 to i64*
  %tmpv.31.sroa.0.0.copyload = load i64, i64* %tmpv.31.sroa.0.0.cast.120.sroa_idx, align 8
  %tmpv.32.sroa.0.0.cast.125.sroa_idx = bitcast i8* %key2 to i64*
  %tmpv.32.sroa.0.0.copyload = load i64, i64* %tmpv.32.sroa.0.0.cast.125.sroa_idx, align 8
...
entry:
  %cast.130 = bitcast i8* %key1 to [61 x { i32, i64, i64 }]*
  %cast.131 = bitcast i8* %key2 to [61 x { i32, i64, i64 }]*
...
then.26:                                          ; preds = %label.0, %entry.split
  ...
  %tmpv.47.sroa.4.0.cast.134.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.130, i64 0, i64 %tmpv.45.018, i32 2
  %tmpv.47.sroa.4.0.copyload = load i64, i64* %tmpv.47.sroa.4.0.cast.134.sroa_idx7, align 8
  %tmpv.47.sroa.3.0.cast.134.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.130, i64 0, i64 %tmpv.45.018, i32 1
  %tmpv.47.sroa.3.0.copyload = load i64, i64* %tmpv.47.sroa.3.0.cast.134.sroa_idx6, align 8
  %tmpv.47.sroa.0.0.cast.134.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.130, i64 0, i64 %tmpv.45.018, i32 0
  %tmpv.47.sroa.0.0.copyload = load i32, i32* %tmpv.47.sroa.0.0.cast.134.sroa_idx, align 8
  %tmpv.48.sroa.0.0.cast.139.sroa_idx = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.131, i64 0, i64 %tmpv.45.018, i32 0
  %tmpv.48.sroa.0.0.copyload = load i32, i32* %tmpv.48.sroa.0.0.cast.139.sroa_idx, align 8
  %tmpv.48.sroa.3.0.cast.139.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.131, i64 0, i64 %tmpv.45.018, i32 1
  %tmpv.48.sroa.3.0.copyload = load i64, i64* %tmpv.48.sroa.3.0.cast.139.sroa_idx4, align 8
  %tmpv.48.sroa.4.0.cast.139.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], [61 x { i32, i64, i64 }]* %cast.131, i64 0, i64 %tmpv.45.018, i32 2
  %tmpv.48.sroa.4.0.copyload = load i64, i64* %tmpv.48.sroa.4.0.cast.139.sroa_idx5, align 8
...
entry:
  %cast.150 = bitcast i8* %key1 to [33 x double]*
  %cast.151 = bitcast i8* %key2 to [33 x double]*
...
label.0:                                          ; preds = %then.41
  ...
  %index.2.1 = getelementptr [33 x double], [33 x double]* %cast.150, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, double* %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], [33 x double]* %cast.151, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  ...
  %index.2.2 = getelementptr [33 x double], [33 x double]* %cast.150, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, double* %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], [33 x double]* %cast.151, i64 0, i64 %add.1.1
...
then.41:                                          ; preds = %label.0.2, %entry.split
  ...
  %index.2 = getelementptr [33 x double], [33 x double]* %cast.150, i64 0, i64 %tmpv.72.011
  %.index.ld.0 = load double, double* %index.2, align 8
  %index.3 = getelementptr [33 x double], [33 x double]* %cast.151, i64 0, i64 %tmpv.72.011
...
entry:
  %cast.154 = bitcast i8* %key1 to [27 x { i8*, i64 }]*
  %cast.155 = bitcast i8* %key2 to [27 x { i8*, i64 }]*
...
then.49:                                          ; preds = %else.48, %entry.split
  ...
  %tmpv.88.sroa.0.0.cast.158.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.154, i64 0, i64 %tmpv.86.019, i32 0
  %tmpv.88.sroa.0.0.copyload = load i8*, i8** %tmpv.88.sroa.0.0.cast.158.sroa_idx, align 8
  %tmpv.88.sroa.3.0.cast.158.sroa_idx3 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.154, i64 0, i64 %tmpv.86.019, i32 1
  %tmpv.88.sroa.3.0.copyload = load i64, i64* %tmpv.88.sroa.3.0.cast.158.sroa_idx3, align 8
  %tmpv.90.sroa.0.0.cast.161.sroa_idx = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.155, i64 0, i64 %tmpv.86.019, i32 0
  %tmpv.90.sroa.0.0.copyload = load i8*, i8** %tmpv.90.sroa.0.0.cast.161.sroa_idx, align 8
  %tmpv.90.sroa.3.0.cast.161.sroa_idx1 = getelementptr [27 x { i8*, i64 }], [27 x { i8*, i64 }]* %cast.155, i64 0, i64 %tmpv.86.019, i32 1
  %tmpv.90.sroa.3.0.copyload = load i64, i64* %tmpv.90.sroa.3.0.cast.161.sroa_idx1, align 8
...
entry:
  ...
  %tmpv.3.sroa.2.0.cast.44.sroa_idx = getelementptr inbounds { { %_type.0*, i8* }, i8 }, { { %_type.0*, i8* }, i8 }* %sret.actual.0, i64 0, i32 1
  %tmpv.3.sroa.2.0.copyload = load i8, i8* %tmpv.3.sroa.2.0.cast.44.sroa_idx, align 8
  %0 = and i8 %tmpv.3.sroa.2.0.copyload, 1
  %trunc.1.not = icmp eq i8 %0, 0
  br i1 %trunc.1.not, label %fallthrough.1, label %then.1

then.1:                                           ; preds = %entry
  %tmpv.3.sroa.0.sroa.2.0.tmpv.3.sroa.0.0.cast.44.sroa_cast.sroa_idx43 = getelementptr inbounds { { %_type.0*, i8* }, i8 }, { { %_type.0*, i8* }, i8 }* %sret.actual.0, i64 0, i32 0, i32 1
  %tmpv.3.sroa.0.sroa.2.0.copyload = load i8*, i8** %tmpv.3.sroa.0.sroa.2.0.tmpv.3.sroa.0.0.cast.44.sroa_cast.sroa_idx43, align 8
  %tmpv.3.sroa.0.sroa.0.0.tmpv.3.sroa.0.0.cast.44.sroa_cast.sroa_cast = bitcast { { %_type.0*, i8* }, i8 }* %sret.actual.0 to i8**
  %tmpv.3.sroa.0.sroa.0.0.copyload = load i8*, i8** %tmpv.3.sroa.0.sroa.0.0.tmpv.3.sroa.0.0.cast.44.sroa_cast.sroa_cast, align 8
...
fallthrough.1:                                    ; preds = %then.1, %entry
  ...
  %tmpv.6.sroa.2.0.cast.54.sroa_idx = getelementptr inbounds { %.1, i8 }, { %.1, i8 }* %sret.actual.1, i64 0, i32 1
  %tmpv.6.sroa.2.0.copyload = load i8, i8* %tmpv.6.sroa.2.0.cast.54.sroa_idx, align 8
  %1 = and i8 %tmpv.6.sroa.2.0.copyload, 1
  %trunc.2.not = icmp eq i8 %1, 0
  br i1 %trunc.2.not, label %fallthrough.2, label %then.2

then.2:                                           ; preds = %fallthrough.1
  %tmpv.6.sroa.0.sroa.2.0.tmpv.6.sroa.0.0.cast.54.sroa_cast.sroa_idx31 = getelementptr inbounds { %.1, i8 }, { %.1, i8 }* %sret.actual.1, i64 0, i32 0, i32 1
  %tmpv.6.sroa.0.sroa.2.0.copyload = load i8*, i8** %tmpv.6.sroa.0.sroa.2.0.tmpv.6.sroa.0.0.cast.54.sroa_cast.sroa_idx31, align 8
  %tmpv.6.sroa.0.sroa.0.0.tmpv.6.sroa.0.0.cast.54.sroa_cast.sroa_cast = bitcast { %.1, i8 }* %sret.actual.1 to i8**
  %tmpv.6.sroa.0.sroa.0.0.copyload = load i8*, i8** %tmpv.6.sroa.0.sroa.0.0.tmpv.6.sroa.0.0.cast.54.sroa_cast.sroa_cast, align 8
  call void @runtime.printlock(i8* nest undef)
...
fallthrough.2:                                    ; preds = %then.2, %fallthrough.1
  call void @runtime.ifaceI2E2({ { %_type.0*, i8* }, i8 }* nonnull sret({ { %_type.0*, i8* }, i8 }) "go_sret" %sret.actual.2, i8* nest undef, i8* bitcast ({ %_type.0*, void (i8*, %S.0*)* }* @imt..interface_4String_bfunc_8_9_8_9_5..main.S to i8*), i8* nonnull %call.1)
  %tmpv.9.sroa.2.0.cast.66.sroa_idx = getelementptr inbounds { { %_type.0*, i8* }, i8 }, { { %_type.0*, i8* }, i8 }* %sret.actual.2, i64 0, i32 1
  %tmpv.9.sroa.2.0.copyload = load i8, i8* %tmpv.9.sroa.2.0.cast.66.sroa_idx, align 8
  %2 = and i8 %tmpv.9.sroa.2.0.copyload, 1
  %trunc.3.not = icmp eq i8 %2, 0
  br i1 %trunc.3.not, label %fallthrough.3, label %then.3

then.3:                                           ; preds = %fallthrough.2
  %tmpv.9.sroa.0.sroa.2.0.tmpv.9.sroa.0.0.cast.66.sroa_cast.sroa_idx24 = getelementptr inbounds { { %_type.0*, i8* }, i8 }, { { %_type.0*, i8* }, i8 }* %sret.actual.2, i64 0, i32 0, i32 1
  %tmpv.9.sroa.0.sroa.2.0.copyload = load i8*, i8** %tmpv.9.sroa.0.sroa.2.0.tmpv.9.sroa.0.0.cast.66.sroa_cast.sroa_idx24, align 8
  %tmpv.9.sroa.0.sroa.0.0.tmpv.9.sroa.0.0.cast.66.sroa_cast.sroa_cast = bitcast { { %_type.0*, i8* }, i8 }* %sret.actual.2 to i8**
  %tmpv.9.sroa.0.sroa.0.0.copyload = load i8*, i8** %tmpv.9.sroa.0.sroa.0.0.tmpv.9.sroa.0.0.cast.66.sroa_cast.sroa_cast, align 8
  call void @runtime.printlock(i8* nest undef)
...
fallthrough.3:                                    ; preds = %then.3, %fallthrough.2
  call void @runtime.ifaceI2I2({ %.1, i8 }* nonnull sret({ %.1, i8 }) "go_sret" %sret.actual.3, i8* nest undef, %_type.0* getelementptr inbounds (%InterfaceType.0, %InterfaceType.0* @main.I..d, i64 0, i32 0), i8* bitcast ({ %_type.0*, void (i8*, %S.0*)* }* @imt..interface_4String_bfunc_8_9_8_9_5..main.S to i8*), i8* nonnull %call.1)
  %tmpv.12.sroa.2.0.cast.77.sroa_idx = getelementptr inbounds { %.1, i8 }, { %.1, i8 }* %sret.actual.3, i64 0, i32 1
  %tmpv.12.sroa.2.0.copyload = load i8, i8* %tmpv.12.sroa.2.0.cast.77.sroa_idx, align 8
  %3 = and i8 %tmpv.12.sroa.2.0.copyload, 1
  %trunc.4.not = icmp eq i8 %3, 0
  br i1 %trunc.4.not, label %fallthrough.4, label %then.4

then.4:                                           ; preds = %fallthrough.3
  %tmpv.12.sroa.0.sroa.2.0.tmpv.12.sroa.0.0.cast.77.sroa_cast.sroa_idx17 = getelementptr inbounds { %.1, i8 }, { %.1, i8 }* %sret.actual.3, i64 0, i32 0, i32 1
  %tmpv.12.sroa.0.sroa.2.0.copyload = load i8*, i8** %tmpv.12.sroa.0.sroa.2.0.tmpv.12.sroa.0.0.cast.77.sroa_cast.sroa_idx17, align 8
  %tmpv.12.sroa.0.sroa.0.0.tmpv.12.sroa.0.0.cast.77.sroa_cast.sroa_cast = bitcast { %.1, i8 }* %sret.actual.3 to i8**
  %tmpv.12.sroa.0.sroa.0.0.copyload = load i8*, i8** %tmpv.12.sroa.0.sroa.0.0.tmpv.12.sroa.0.0.cast.77.sroa_cast.sroa_cast, align 8
  call void @runtime.printlock(i8* nest undef)
...
fallthrough.4:                                    ; preds = %then.4, %fallthrough.3
  ...
  %4 = and i8 %call.3.fca.1.extract, 1
...
fallthrough.5:                                    ; preds = %then.5, %fallthrough.4
  ...
  %call.5 = call { i8*, i8 } @runtime.ifaceI2T2P(i8* nest undef, %_type.0* getelementptr inbounds (%PtrType.0, %PtrType.0* @main.S..p, i64 0, i32 0), i8* bitcast ({ %_type.0*, void (i8*, %S.0*)* }* @pimt..interface_4String_bfunc_8_9_8_9_5..main.S to i8*), i8* nonnull %call.4)
  %call.5.fca.1.extract = extractvalue { i8*, i8 } %call.5, 1
  %5 = and i8 %call.5.fca.1.extract, 1
